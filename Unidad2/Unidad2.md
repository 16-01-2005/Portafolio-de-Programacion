...
📌 <i>Realicé una calculadora básica en Java 🧮 capaz de ejecutar las cuatro operaciones fundamentales: suma ➕, resta ➖, multiplicación ✖️ y división ➗.  
...
El propósito de esta calculadora es demostrar el uso práctico de bucles, condicionales y manejo de entradas en Java 💻, permitiendo al usuario realizar varias operaciones dentro del mismo flujo del programa 🌀 de manera segura y controlada.</i>
